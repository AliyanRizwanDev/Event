...
export const updateDiscountCode = async (req, res) => {
    try {
        const updatedDiscountCode = await DiscountCode.findOneAndUpdate({ code: req.params.code }, req.body, { new: true });
...
export const deleteDiscountCode = async (req, res) => {
    try {
        const deletedDiscountCode = await DiscountCode.findOneAndDelete({ code: req.params.code });
